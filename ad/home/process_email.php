                            ...
                            <table border='0' align='center' width='590' cellpadding='0' cellspacing='0' class='container590'>
                                ...
                                <tr>
                                    <td align='center' height='70' style='height:70px;'>
                                        <a href='' style='display: block; border-style: none !important; border: 0 !important;'><img width='100' border='0' style='display: block; width: 100px;' src='https://www.crystal-crypt.com/logo.png' alt='' /></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align='center' style='color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;' class='main-header'>
                            ...
                            <div style='line-height: 35px'>
                                ...
                                Hello <span style='color: #5caad2;'></span>
                        ...
                        <td>
                            <table border='0' width='300' align='left' cellpadding='0' cellspacing='0' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='container590'>
                                ...
                                <tr>
                                    <!-- logo -->
                                    <td align='center'>
                                        <a href='' style=' border-style: none !important; display: block; border: 0 !important;'><img src='https://www.crystal-crypt.com/logo.png' style='display: block; width: 590px;' width='590' border='0' alt='' /></a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align='left' style='color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;' class='text_color'>
                                        <div style='color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;'>
                                            ...
                                            Email us: <br/> <a href='mailto:' style='color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;'>support@crystal-crypt.com</a>
                                        ...
                                        <div style='color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;'>
                                            ...
                                            Contact us: <br/> <a href='mailto:' style='color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;'>            <h4>+16186800177</h4></a>
                                            
            <h4>Best Regards,</h4>
            <h4>crystal-crypt.com.</h4>
            <h4>www.crystal-crypt.com</h4>
...
$subject = $subject;
$body = $message;
$from = 'support@crystal-crypt.com'; 
$fromName = 'crystal-crypt'; 
...
$headers .= 'Cc: support@crystal-crypt.com' . "\r\n"; 
$headers .= 'Bcc: support@crystal-crypt.com' . "\r\n"; 
